...
describe("analyzeOpcode()", () => {
  test("opcode that starts with 99 should just return nothing", () => {
    expect(alarm.analyzeOpcode([99], 0)).toBe("STOP");
  });
...
describe("takeOpcode()", () => {
  describe("opcode [1,9,10,3,2,3,11,0,99,30,40,50]", () => {
    test("should return array[0] equals 3500", () => {
      expect(
        alarm.takeOpcode([1, 9, 10, 3, 2, 3, 11, 0, 99, 30, 40, 50])[0]
      ).toBe(3500);
    });
  });
  describe("opcode problem 2", () => {
    test("should return array[0] equals 5866714", () => {
      expect(
        alarm.takeOpcode([
          1,
          12,
...
describe("findPairs", () => {
  test("should return the pairs", () => {
    expect(alarm.takeOpcode([]));
  });
});
