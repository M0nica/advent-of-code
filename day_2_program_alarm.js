...
function takeOpcode(array) {
  ...
  while (
    analyzeOpcode(outputArray, currentFirstIndex) != "STOP" &&
    // currentFirstIndex < outputArray.length - 1 &&
    outputArray[currentFirstIndex]
  ) {
    if (analyzeOpcode(outputArray, currentFirstIndex) != "STOP") {
